...
\hypersetup{
  ...
  pdfauthor={{[}Instructor / Institution / Programme Team{]}},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\vspace{-3mm}\textbf{Source basis}\vspace{3mm}

This curriculum is designed from the uploaded requirements document,
which specifies a beginner-to-intermediate Python pathway for a
PhD-trained real estate finance and climate-risk professional,
structured over 12 weeks / 90 days at 4-6 hours per week, with direct
application to flood risk, physical climate risk, transition risk, real
estate pricing, valuation, REITs, investment analytics, reproducible
workflows and future dashboard/product development.
